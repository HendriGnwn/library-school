...
-- Waktu pembuatan: 09 Apr 2016 pada 12.33
...
(8, 'BO-1604-000005', 'Bahasa Indonesia 4', 'Gunawan Hendri', 'Nusantara Tekmulti', 2010, 'Yogyakarta', 80, 50, '', '', 20, 55000, 6, 'BOS', '123123', 'Ok', 5, 10, 'book_dummy.png', 10, '2016-04-06 21:12:09', NULL, 1, NULL),
...
--
-- Struktur dari tabel `detail_loaning_book`
--

CREATE TABLE IF NOT EXISTS `detail_loaning_book` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data untuk tabel `detail_loaning_book`
--
...
--
-- Struktur dari tabel `loaning_book`
--

CREATE TABLE IF NOT EXISTS `loaning_book` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data untuk tabel `loaning_book`
--
...
--
-- Struktur dari tabel `previous_education`
--
...
--
-- Dumping data untuk tabel `previous_education`
--
...
--
-- Struktur dari tabel `rack_book`
--

CREATE TABLE IF NOT EXISTS `rack_book` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(80) NOT NULL,
  `description` varchar(500) NOT NULL,
  `status` int(11) NOT NULL COMMENT '10=Active, 0=Inactive',
...
--
-- Dumping data untuk tabel `rack_book`
--
...
--
-- Struktur dari tabel `reimbursement_book`
--

CREATE TABLE IF NOT EXISTS `reimbursement_book` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `loaning_book_id` int(11) NOT NULL,
  `reimbursement_date` date NOT NULL,
...
--
-- Dumping data untuk tabel `reimbursement_book`
--
...
--
-- Struktur dari tabel `school_info`
--
...
--
-- Dumping data untuk tabel `school_info`
--

INSERT INTO `school_info` (`id`, `npsn`, `name`, `description`, `no_telp`, `email`, `kepsek`, `address`, `logo`) VALUES
(1, '123', 'SDN Carlir 03', 'SDN', '0251', 'sdn.testing@gmail.com', 'Hendri Gunawan', 'Jl Wangun Jaya', 'logo.png');
...
(1, 1, 10, 'Hendri Gunawan', 'hendri.gunawan@computesta.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', 10, '0000-00-00 00:00:00', NULL, NULL, '2016-04-03 21:47:50', 1),
