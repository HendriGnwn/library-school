...
class StudentController extends MyController
{
	public function actionReport() {
		$model = new Student('filterBetweenDate');
	...
	public function actionImport() {
		...
		if(isset($_FILES['ImportStudentForm'])) {
			$model->attributes = $_FILES['ImportStudentForm'];
			$file = ($_FILES['ImportStudentForm']['error']['file'] === 0) ? true : false;
			if (!empty($_FILES['ImportStudentForm']['name']['file']) && $file){
	...
	public function actionCreate()
	{
		...
		if (isset($_POST['Student'])) {
			...
			$photo = ($_FILES['Student']['error']['photo'] === 0) ? true : false;
			if (!empty($_FILES['Student']['name']['photo']) && $photo){
