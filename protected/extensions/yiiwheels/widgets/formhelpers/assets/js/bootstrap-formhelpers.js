  ...
  BFHNumber.prototype = {
    ...
    initInput: function() {
      ...
      if (this.options.buttons === true) {
        ...
        this.$element.parent().append('<span class="input-group-addon bfh-number-btn inc"><span class="fa fa-arrow-up"></span></span>');
        this.$element.parent().append('<span class="input-group-addon bfh-number-btn dec"><span class="fa fa-arrow-down"></span></span>');
      }
