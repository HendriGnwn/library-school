...
$this->menu=array(
	...
	array('label'=>'Update Kategori Buku', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete Kategori Buku', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
);
?>
...
<div class="row">
	<div class="col-sm-12">
		<div class="box box-color box-bordered">
			<div class="box-title">
				<h3>
					<i class="fa fa-th-list"></i>View Kategori Buku #<?php echo $model->id; ?>
				</h3>
			</div>
