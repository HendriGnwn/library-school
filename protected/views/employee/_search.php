...
<div class="wide form">
	...
	'method'=>'get',
                    ...
                    <?php echo $form->textFieldCustomGroup($model,'position_id',array('class'=>'form-control')); ?>

                    <?php echo $form->textFieldCustomGroup($model,'date_in',array('class'=>'form-control')); ?>

                    <?php echo $form->textFieldCustomGroup($model,'empoyee_status',array('class'=>'form-control')); ?>
