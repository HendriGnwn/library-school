...
<div class="form">
    ...
    <?php echo $form->errorSummary($model); ?>
            ...
            <?php echo $form->textFieldCustomGroup($model,'member_code', array('value'=>$model->isNewRecord ? Teacher::model()->generateCode() : $model->member_code, 'readonly'=>true)); ?>
            ...
            <?php echo $form->dropDownListCustomGroup($model,'gender', Teacher::genderLabels(), array('class'=>'form-control select2-me', 'prompt'=>'--Choose One--')); ?>
            ...
            <?php echo $form->dropDownListCustomGroup($model,'marital_status', Teacher::maritalStatusLabels(), array('class'=>'form-control select2-me', 'prompt'=>'--Choose One--')); ?>

            <?php echo $form->dropDownListCustomGroup($model,'teacher_status', Teacher::teacherStatusLabels(), array('class'=>'form-control select2-me', 'prompt'=>'--Choose One--')); ?>
			...
			<?php echo $form->dropDownListCustomGroup($model,'status', Teacher::statusLabels(), array('class'=>'form-control select2-me')); ?>
