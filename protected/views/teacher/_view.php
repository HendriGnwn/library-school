...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('teacher_status')); ?>:</b>
	<?php echo CHtml::encode($data->teacher_status); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('instance_previous_education')); ?>:</b>
	<?php echo CHtml::encode($data->instance_previous_education); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('graduation_year')); ?>:</b>
	<?php echo CHtml::encode($data->graduation_year); ?>
	<br />
