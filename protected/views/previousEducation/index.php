...
<div class="row">
	<div class="col-sm-12">
		<div class="box box-color box-bordered">
			<div class="box-title">
				<h3>
					<i class="fa fa-th-list"></i>Manage Pendidikan Terakhir
				</h3>
			</div>
			<div class="box-content">
				<?php echo CHtml::link('Tambah Pendidikan Terakhir', array($this->id.'/create'), array('class'=>'btn btn-primary')); ?>
				<?php $this->widget('zii.widgets.grid.CGridView',array(
					'id'=>'previous-education-grid',
