...
$this->menu=array(
	...
	array('label'=>'Update Pendidikan Terakhir', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete Pendidikan Terakhir', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
);
?>
...
<div class="row">
	<div class="col-sm-12">
		<div class="box box-color box-bordered">
			<div class="box-title">
				<h3>
					<i class="fa fa-th-list"></i>View Pendidikan Terakhir #<?php echo $model->id; ?>
				</h3>
			</div>
